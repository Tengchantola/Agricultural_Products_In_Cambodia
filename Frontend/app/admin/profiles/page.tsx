        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center p-4 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors group"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center p-4 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors group"
            >
